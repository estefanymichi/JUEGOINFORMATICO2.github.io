const questions = [
    ...
    { question: "¿Qué tipo de información se registra en el SEACE?", answer: "Documentos de actos preparatorios, procedimientos de selección y ejecución contractual" },
    ...
    { question: "¿Cuáles son los tipos de gastos?", answer: "Gasto corriente, Gasto de capital y servicio de deuda" },
    ...
    { question: "Existen 4 tipos de registros en los que te puedes inscribir en el RNP ¿Cuáles son?", answer: "Proveedor de Servicios, Proveedor de Bienes,Consultor de obras y Ejecutor de obras" },
    { question: "¿Quién es la Presidenta Ejecutiva del OSCE?", answer: "Laura Lisset  Gutierrez Gonzales" },
    { question: "Según las funciones de la central de compras públicas, la compra corporativa se divide en 2 ¿Cuáles son?", answer: "Obligatorias y Facultativas" },
    ...
    { question: "¿Cual es la cadena de ingreso de “Derechos examen de admisión”?", answer: "132312" },
    { question: "¿Cual es la cadena de ingreso de “Duplicado Documento Nacional de Identidad”?", answer: "132133" },
    { question: "¿Cual es la cadena de gasto de “Textos escolares”?", answer: "222321" },
    { question: "¿Cual es la cadena de gasto de “Papelería en general , útiles  y materiales de oficina”?", answer: "231512" },
    { question: "¿Cual es la cadena de gasto de “Servicio de internet”?", answer: "232223" },
    { question: "¿Cuáles son los métodos de contratación?", answer: "Licitación Pública, Concurso Público, Adjudicación Simplificada, Contratación Directa, Comparación de Precios, Subasta Inversa Electrónica, Selección de Consultores Individuales y Concurso de Proyectos Arquitectónicos" },
    { question: "¿Qué es el Rubro 13?", answer: "Donaciones y Transferencias" },
    { question: "¿Qué versiones del SEACE están en uso?", answer: "Versión 2.0 y Versión 3.0"},
    { question: "¿Qué es el Rubro 07?", answer: "Fondo de compensación Municipal" },
    { question: "¿Qué es el Rubro 08?", answer: "Otros Impuestos Municipales" },
    { question: "¿Qué es el Rubro 15?", answer: "Fondo de Compensación Regional" },
    { question: "¿Qué es el Rubro 04?", answer: "Contribuciones a Fondos" },
    { question: "¿Qué es el Rubro 00?", answer: "Recursos Ordinarios" },
    { question: "¿Qué es el Rubro 09?", answer: "Recursos Directamente Recaudados" },
    { question: "¿Qué es el Rubro 19?", answer: "Recursos por Operaciones Oficiales de Crédito"},
    { question: "Las categorías presupuestales son 3 ¿Cuáles son?", answer: "PP, AC y APNOP" },
    { question: "¿Cuáles son los Recursos Públicos?", answer: "Recursos Humanos, Recursos Financieros y Recursos Materiales" },
